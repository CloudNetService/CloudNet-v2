...
public class VaultChatImpl extends Chat {
    ...
    public String getPlayerPrefix(String s, String s1)
    {
        ...
        return offlinePlayer.getPermissionEntity().getPrefix() != null ?
                offlinePlayer.getPermissionEntity().getPrefix() : offlinePlayer.getPermissionEntity().getHighestPermissionGroup(CloudAPI.getInstance().getPermissionPool()).getPrefix();
    }
    ...
    public String getPlayerSuffix(String s, String s1)
    {
        ...
        return offlinePlayer.getPermissionEntity().getSuffix() != null ?
                offlinePlayer.getPermissionEntity().getSuffix() : offlinePlayer.getPermissionEntity().getHighestPermissionGroup(CloudAPI.getInstance().getPermissionPool()).getSuffix();
    }
