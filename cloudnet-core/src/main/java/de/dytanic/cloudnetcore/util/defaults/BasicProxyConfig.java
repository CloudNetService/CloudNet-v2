...
public class BasicProxyConfig extends ProxyConfig {
    ...
    public BasicProxyConfig()
    {
        super(true, false, Arrays.asList(new Motd(
                ...
                )), new Motd("   §b§lCloud§f§lNet§8■ §7your §bfree §7cloudsystem §8§l【§f%version%§8§l】", "         §bMaintenance §8» §7We are still in §bmaintenance"),
                "§8➜ §bMaintenance §8§l【§c✘§8§l】",1000, false, true, new AutoSlot(0, false),
                new TabList(true,
