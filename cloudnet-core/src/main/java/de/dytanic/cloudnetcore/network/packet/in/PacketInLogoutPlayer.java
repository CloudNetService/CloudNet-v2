 ...
 */
public class PacketInLogoutPlayer
    ...
    public void handleInput(Document data, PacketSender packetSender)
    {
        ...
        CloudNet.getInstance().getNetworkManager().handlePlayerLogout(data.getObject("uniqueId", new TypeToken<UUID>(){}.getType()), ((ProxyServer)packetSender));
    }
}